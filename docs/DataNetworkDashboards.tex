...
\label{fig:dashboardsLayout}Example of a dashboards tool presenting the databases available in the network (simulated data)
...
\addcontentsline{toc}{subsection}{External Node Packages}
