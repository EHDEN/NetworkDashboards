                ...
                with transaction.atomic(
                    ...
                    cursor.execute(
                        ...
                        INSERT INTO {AchillesResultsArchive._meta.db_table} (
                            {AchillesResultsArchive.analysis_id.field.name},
                            {AchillesResultsArchive.stratum_1.field.name},
                            {AchillesResultsArchive.stratum_2.field.name},
                            {AchillesResultsArchive.stratum_3.field.name},
                            {AchillesResultsArchive.stratum_4.field.name},
                            {AchillesResultsArchive.stratum_5.field.name},
                            {AchillesResultsArchive.count_value.field.name},
                            {AchillesResultsArchive.min_value.field.name},
                            {AchillesResultsArchive.max_value.field.name},
                            {AchillesResultsArchive.avg_value.field.name},
                            {AchillesResultsArchive.stdev_value.field.name},
                            {AchillesResultsArchive.median_value.field.name},
                            {AchillesResultsArchive.p10_value.field.name},
                            {AchillesResultsArchive.p25_value.field.name},
                            {AchillesResultsArchive.p75_value.field.name},
                            {AchillesResultsArchive.p90_value.field.name},
                            {AchillesResultsArchive.data_source.field.column},
                            {AchillesResultsArchive.upload_info.field.column}
                        )
                        SELECT
                            {AchillesResults.analysis_id.field.name},
                            {AchillesResults.stratum_1.field.name},
                            {AchillesResults.stratum_2.field.name},
                            {AchillesResults.stratum_3.field.name},
                            {AchillesResults.stratum_4.field.name},
                            {AchillesResults.stratum_5.field.name},
                            {AchillesResults.count_value.field.name},
                            {AchillesResults.min_value.field.name},
                            {AchillesResults.max_value.field.name},
                            {AchillesResults.avg_value.field.name},
                            {AchillesResults.stdev_value.field.name},
                            {AchillesResults.median_value.field.name},
                            {AchillesResults.p10_value.field.name},
                            {AchillesResults.p25_value.field.name},
                            {AchillesResults.p75_value.field.name},
                            {AchillesResults.p90_value.field.name},
                            %s, %s
