...
def fill_apha2(apps, schema_editor):
    ...
    with open(path.join(settings.BASE_DIR, "uploader", "fixtures", "countries.json")) as countries_file:
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='country',
            name='alpha2',
            field=models.CharField(default="", help_text='ISO 3166-1 Alpha-2 Code', max_length=3),
        ...
        migrations.AlterField(
                model_name='country',
                name='alpha2',
                field=models.CharField(default="", help_text='ISO 3166-1 Alpha-2 Code', max_length=3, unique=True),
                preserve_default=False,
        ),
    ]
