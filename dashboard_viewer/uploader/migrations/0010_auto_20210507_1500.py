            ...
            with open("acronym2hash_mappings.json") as mappings_file:
                ...
                for data_source in data_sources:
                    try:
                        ...
                        raise KeyError(f'No mapping for data source with acronym "{data_source.acronym}"')

                DataSource.objects.bulk_update(data_sources)
        except FileNotFoundError:
            raise FileNotFoundError("There are DataSources on the database, for that a mappings file is"
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='datasource',
            name='hash',
            field=models.CharField(blank=True, default=lambda: uuid.uuid4().hex, max_length=255, null=False,
                                   unique=True),
        ),
        ...
        migrations.AlterField(
            ...
            name='data_source',
            field=models.ForeignKey(limit_choices_to={'draft': False}, on_delete=django.db.models.deletion.CASCADE,
