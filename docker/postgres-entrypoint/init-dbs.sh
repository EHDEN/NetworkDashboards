...
# based of https://github.com/mrts/docker-postgresql-multiple-databases

set -eu

if [ -n "$POSTGRES_DBS" ] ; then
  # Get arrays with information for the several databases to create
  ...
  # Check if all have the same lenght
